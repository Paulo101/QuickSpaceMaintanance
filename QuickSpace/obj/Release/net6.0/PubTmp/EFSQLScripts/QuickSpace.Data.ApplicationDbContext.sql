...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220222095943_secondMig')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220222095943_secondMig')
BEGIN
    ALTER TABLE [AspNetUsers] ADD [ParentId] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220222095943_secondMig')
BEGIN
    ALTER TABLE [AspNetUsers] ADD [RefferalId] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220222095943_secondMig')
BEGIN
    ALTER TABLE [AspNetUsers] ADD [VerificationCode] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO
...
BEGIN
    CREATE TABLE [Wallets] (
        ...
        [WalletHolder] nvarchar(max) NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20220222095943_secondMig', N'6.0.1');
END;
GO
